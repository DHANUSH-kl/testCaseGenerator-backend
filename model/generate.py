...
def generate_with_fallback(srs_text):
    """Main entrypoint for test case generation."""
...
def generate_with_ai_model(srs_text, tokenizer, model):
    """Generate test cases with an AI model under memory constraints."""
...
def generate_template_based_test_cases(srs_text):
    """Generate test cases using simple keyword logic."""
...
def parse_generated_test_cases(generated_text):
    """Extract structured test cases from raw model output."""
